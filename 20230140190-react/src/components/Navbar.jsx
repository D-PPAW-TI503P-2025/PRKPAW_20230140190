            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:flex items-center space-x-3">
                        <Link
                            to="/dashboard"
                            className={`px-6 py-2.5 rounded-full font-medium transition-all ${isActive("/dashboard") ? activeClass : inactiveClass
                                }`}
                        >
                            Dashboard
                        </Link>
                        ...
                        {user.role === "admin" && (
                            <Link
                                to="/reports"
                                className={`px-6 py-2.5 rounded-full font-medium transition-all ${isActive("/reports") ? activeClass : inactiveClass
                                    }`}
                            >
                                Laporan Admin
                            </Link>
                ...
                <div className="md:hidden bg-white border-t border-gray-200">
                    <div className="px-4 py-5 space-y-3">
                        ...
                        <Link
                            ...
                            className={`block px-6 py-3 rounded-full font-medium ${isActive("/dashboard") ? activeClass : "text-gray-700"
                                }`}
                        >
                            Dashboard
                        </Link>
                        <Link
                            to="/Presensi"
                            onClick={() => setMobileMenuOpen(false)}
                            className={`block px-6 py-3 rounded-full font-medium ${isActive("/Presensi") ? activeClass : "text-gray-700"
                                }`}
                        >
                            Presensi
                        </Link>
                        {user.role === "admin" && (
                            <Link
                                to="/reports"
                                onClick={() => setMobileMenuOpen(false)}
                                className={`block px-6 py-3 rounded-full font-medium ${isActive("/reports") ? activeClass : "text-gray-700"
                                    }`}
                            >
                                Laporan Admin
                            </Link>
